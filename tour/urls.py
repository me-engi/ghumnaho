...
from .views import TourListView, TourDetailView, TourImagesView, TourSearchView, PopularTourListView, TrendingTourListView, apply_coupon
from .views import TourAvailabilityListView, TourAvailabilityDetailView
...
urlpatterns = [
    ...
    path('popular/<int:pk>',PopularTourListView.as_view(), name="popular-tour" ),
    path('trending/<int:pk>',TrendingTourListView.as_view(), name="trending-tour" ),
