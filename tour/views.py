...
class TourSearchView(RetrieveAPIView):
    queryset = Tour.objects.all()
    serializer_class = TourDetailSerializer
...
def apply_coupon(request):
    ...
    if request.method == 'GET':
        try:
            # Implement your logic to retrieve coupon-related data for GET requests
            # For example, get a list of available coupons
        ...
        try:
            ...
            # Update the max uses of the coupon
            coupon.max_uses -= 1
            coupon.save()
